...
def get_weather(city: str):
    ...
    Args:
    city(str): city name(eg: New Delhi)
...
def temperature_of_city(city):
    system_instructions = """
       ...
       3. Include: current temperature, feels-like temperature, main weather description,
          humidity, wind speed, and sunrise/sunset times (converted from UNIX timestamp to the city's local time).
       4. Use natural, conversational language.
       5. Based on the current conditions, suggest what the person should carry or wear.
          - If rain/clouds: suggest carrying umbrella/raincoat.
...
def get_news(topic: str):
    ...
    Args:
    topic(str): Topic for top headlines (eg: technology, cricket, etc.)
    """
    try:
...
def smart_plan(city):
    ...
    Input Example:
    Weather Forecast:
    On Saturday, October 4, 2025, Chandigarh is expected to be cloudy with a maximum temperature ranging from 30°C to 34°C (86°F to 93°F) 
    and a minimum temperature between 25°C and 26°C (77°F to 79°F). There is a 25% to 65% chance of rain during the day and a 40% to 45% 
    chance of rain at night. The humidity is anticipated to be around 82% to 86%.
